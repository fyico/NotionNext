...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://impartial-catsup-ba4.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Fuyuki', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的Synthsizer V翻调P主 / SO-VITS-SVC 创作者，喜欢邦邦', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.arisa.uk', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Fuyuki, 博客, Synthsizer V, SO-VITS-SVC, BanG Dream! ', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20250947号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=20250947', // 备案查询链接，如果用了萌备等备案请在这里填写
  BEI_AN_GONGAN: process.env.NEXT_PUBLIC_BEI_AN_GONGAN || '', // 公安备案号，例如 '浙公网安备3xxxxxxxx8号'

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'fuyuki@arisa.uk', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/fyico', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/388555478', // B站主页
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个普通的Synthsizer V翻调P主, Hi，我是一个普通的 SO-VITS-SVC 创作者,我喜欢邦邦,欢迎来到我的博客🎉',
