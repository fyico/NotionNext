...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '風由紀', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的Synthesizer V 翻调P主 / SO-VITS-SVC 创作者，喜欢邦邦，在B站发视频', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://arisa.uk', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '流星堂, 博客', // 网站关键词 英文逗号隔开
